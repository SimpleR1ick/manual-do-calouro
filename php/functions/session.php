    ...
    if (isset($_SESSION['id_usuario'])) {
        ...
        "<div class='dropdown'>
            <button class='btn border-none dropdown-toggle' type='button' data-bs-toggle='dropdown' aria-expanded='false'>
                ...
                <img id='img-perfil' alt='user-pic' src='public/$path'>.
            </button>
...
function exibirFoto(): void {
    ...
    if (isset($_SESSION['id_usuario'])) {
        ...
        if (!empty($path)) {
            ...
            echo "<img id='foto-editar-perfil' class='img-fluid' alt='user-pic' src='public/uploads/$path'>";
        } else {
            // Imagem Default 
            echo '<img id="foto-editar-perfil" class="img-fluid rounded" alt="user-pic" src="public/images/user.png">';
        }
    }
}
