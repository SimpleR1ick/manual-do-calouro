...
<section class="container">
    ...
    <div class="d-flex flex-column align-items-center pt-4 border rounded">
        <!--
        <nav class="nav border border-danger col-md-7">
        ...
        <!-- CARD CONTATO -->
        <div class="accordion col-md-7 mb-4" id="contato-1">
        ...
        <div class="accordion col-md-7 mb-4" id="contato-2">
            <div class="accordion-item">
                <h2 class="accordion-header" id="titulo-2">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#regras-2" aria-expanded="false" aria-controls="regras-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-8 d-flex align-items-center">
                                <div class="card-body">
                                    <h5 class="card-title fw-bold">Departamento X</h5>
