...
<section class="container">
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active border py-4 px-2" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                ...
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#regras-2" aria-expanded="false" aria-controls="regras-2">
                                    ...
                                    <div class="row w-100">
                                        ...
                                        <div class="col-9 d-flex align-items-center">
                                            <div class="card-body">
                                                <h5 class="card-title fw-bold text-break mb-1">CSJISKAD</h5>
                ...
                <!-- CARD CONTATO -->
                <div class="d-flex flex-column align-items-center">
                    <div class="accordion col-md-7 mb-2" id="contato-3">
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="titulo-3">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#regras-3" aria-expanded="false" aria-controls="regras-3">
                                    ...
                                    <div class="row w-100">
                                        ...
                                        <div class="col-9 d-flex align-items-center">
                                            <div class="card-body">
                                                <h5 class="card-title fw-bold text-break mb-1">Coordenadora Daisjdi  ede a ajuda help mroet</h5>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 py-1">
                                                        <span>
                                                            <i class="fa-solid fa-envelope"></i>
                                                            <span class="text-break">aaaaaaaaaaaaaaaaaaadeptox@ifes.edu.br</span>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div id="regras-3" class="accordion-collapse collapse" aria-labelledby="titulo-3" data-bs-parent="#contato-3">
                                <div class="accordion-body">
                                    <h5>Horário de funcionamento:</h5>
                                    <p>
                                        00:00 - 00:15
